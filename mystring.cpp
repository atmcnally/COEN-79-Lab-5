...
//     within this string is returned. If the string does not contain c, -1 is is returned.

int string::search(const string& substring) const {

}
//     Postcondition: Returns the index of the start of the first instance of
//     the given substring inside of this string. If the substring is not found, this function returns -1.
